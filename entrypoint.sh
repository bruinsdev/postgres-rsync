...
ln -s /root/sshd/ssh_host_rsa_key /etc/ssh
ln -s /root/sshd/ssh_host_rsa_key.pub /etc/ssh
ln -s /root/sshd/ssh_host_dsa_key /etc/ssh
ln -s /root/sshd/ssh_host_dsa_key.pub /etc/ssh
ln -s /root/sshd/ssh_host_ecdsa_key /etc/ssh
ln -s /root/sshd/ssh_host_ecdsa_key.pub /etc/ssh
